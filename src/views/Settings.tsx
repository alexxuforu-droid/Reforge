...
import { errorCopy, call, fmt, IS_TAURI, swallow } from "../lib/api";
...
export default function Settings() {
  ...
  return (
    <div>
      ...
      {/* Automation */}
      <Suspense fallback={<div className="pt-8 text-xs text-[var(--text-tertiary)]">Loading automation…</div>}>
        <AutomationSection
          t={t}
          ...
          runDueMaintenance={runDueMaintenance}
          blueOn={blueOn}
          blueIntensity={blueIntensity}
          setBlueIntensity={setBlueIntensity}
          toggleBlueLight={toggleBlueLight}
          blSchedule={blSchedule}
          setBlSchedule={setBlSchedule}
          blStart={blStart}
          setBlStart={setBlStart}
          blEnd={blEnd}
          setBlEnd={setBlEnd}
          styleSchedule={styleSchedule}
          updateScheduledStyle={updateScheduledStyle}
          removeScheduledStyle={removeScheduledStyle}
          addScheduledStyle={addScheduledStyle}
          pickStyleId={pickStyleId}
          setPickStyleId={setPickStyleId}
          pickTime={pickTime}
          setPickTime={setPickTime}
          styleOptions={styleOptions}
          installedBundles={installedBundles}
          pickPackId={pickPackId}
          setPickPackId={setPickPackId}
          pickPackTime={pickPackTime}
          setPickPackTime={setPickPackTime}
          addScheduledPack={addScheduledPack}
        />
      </Suspense>
...
/** S11.6 countdown helper moved to AutomationSection (verbatim). */
